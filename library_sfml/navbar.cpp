...
void navbar::onNavHover(Vector2f pos)
{
	...
	else if (file_management::users[file_management::selectedUser].usertype=="Admin" && orders.button.getGlobalBounds().contains(pos)) {
		logout.buttonText.setFillColor(Color(210, 105, 30, 128));
		orders.buttonText.setFillColor(Color(210, 105, 30));
		home.buttonText.setFillColor(Color(210, 105, 30,128));  
	}
	else if (file_management::users[file_management::selectedUser].usertype == "Reader" && cart.button.getGlobalBounds().contains(pos)) {
	...
	else if (file_management::users[file_management::selectedUser].usertype == "Reader" && history.button.getGlobalBounds().contains(pos)) {
		logout.buttonText.setFillColor(Color(210, 105, 30, 128));
		cart.buttonText.setFillColor(Color(210, 105, 30, 128));
		home.buttonText.setFillColor(Color(210, 105, 30, 128));
